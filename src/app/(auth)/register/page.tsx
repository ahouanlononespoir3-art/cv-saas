    ...
    <div className="card p-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <p className="text-xs text-surface-400">
          ...
          <Link href="/terms" className="text-brand-600 hover:underline">CGU</Link>
          {' '}et notre{' '}
          <Link href="/privacy" className="text-brand-600 hover:underline">politique de confidentialité</Link>.
        </p>
